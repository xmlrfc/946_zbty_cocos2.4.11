  ...
  o.prototype.setLevelData = function () {
    return a(this, undefined, undefined, function () {
      ...
      return c(this, function (i) {
        switch (i.label) {
          case 0:
            if (window.levelResModel14_wenzizhaobutong) {
              return [3, 2];
            } else {
              e = window;
          ...
          case 1:
            e.levelResModel14_wenzizhaobutong = i.sent();
            i.label = 2;
          case 2:
            this.levelData = window.levelResModel14_wenzizhaobutong.json.data[window.currentLevel - 1];
