...
var l = function (e) {
  ...
  o.prototype.onTouchMove = function (e) {
    ...
    o = this.node.convertToNodeSpaceAR(o);
    this.draw.clear();
    this.draw.moveTo(this.prePoint.x, this.prePoint.y);
  ...
  o.prototype.onTouchEnd = function (e) {
    ...
    var t = o;
    o = this.node.convertToNodeSpaceAR(o);
    if (cc.director.getPhysicsManager().rayCast(this.preWorldPoint, t, cc.RayCastType.All).length <= 0) {
      window.game.movingFlag = false;
    } else {
      window.game.cut(this.prePoint, o);
    }
  };
  return r([c], o);
}(cc.Component);
