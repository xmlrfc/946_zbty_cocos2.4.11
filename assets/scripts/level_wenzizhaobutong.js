  ...
  o.prototype.showItem = function () {
    return a(this, undefined, undefined, function () {
      ...
      return c(this, function () {
        e = window.levelMaxModel;
        if (window.home && window.home.isModelNowInModel12()) {
          e = window.model12Arr.length;
        }
        o = 0;
        for (; o < e; o++) {
          (t = cc.instantiate(this.itemPrefab)).getChildByName("bg").getComponent(cc.Sprite).spriteFrame = this.bgsprite[1];
          t.getComponent("levelItem_wenzizhaobutong").init(o + 1);
