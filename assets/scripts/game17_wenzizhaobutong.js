      ...
      return c(this, function (c) {
        switch (c.label) {
          case 0:
            ...
            if (window.levelResModel17_wenzizhaobutong) {
              return [3, 2];
            } else {
              o = window;
          ...
          case 1:
            o.levelResModel17_wenzizhaobutong = c.sent();
            c.label = 2;
          case 2:
            if (window.ziRelResModel17) {
              return [3, 4];
            } else {
              t = window;
          ...
          case 3:
            t.ziRelResModel17 = c.sent();
            c.label = 4;
          case 4:
            if (window.ziWrongModel17) {
              return [3, 6];
            } else {
              n = window;
          ...
          case 5:
            n.ziWrongModel17 = c.sent();
            c.label = 6;
          case 6:
            i = window.ziRelResModel17.json[window.levelResModel17_wenzizhaobutong.json[window.currentLevel - 1]];
            r = window.ziWrongModel17.json.data;
            a = i.child.slice(0);
            i.ans = a.split(",");
            this.dataComLength = i.ans.length;
            this.dataCom = i.ans.slice(0);
            this.question.string = i.zi_content;
            l = i.ans;
            d = [];
            s = [];
            u = 0;
          ...
          case 8:
            ...
            y.addComponent("clickNode_wenzizhaobutong");
            if (m >= 0) {
              g = l[v];
              this.diffNode = y;
              y.getComponent("clickNode_wenzizhaobutong").setSuccessFlag(true);
            } else {
              _ = Math.floor(Math.random() * r.length);
              g = r[_];
              for (; this.include(l, g) || this.include(w, g);) {
                _ = Math.floor(Math.random() * r.length);
                g = r[_];
              }
              w.push(g);
              y.getComponent("clickNode_wenzizhaobutong").setSuccessFlag(false);
            }
            y.getComponent(cc.Label).string = g;
            this.layoutNode.addChild(y);
            c.label = 9;
          case 9:
            p++;
            return [3, 7];
