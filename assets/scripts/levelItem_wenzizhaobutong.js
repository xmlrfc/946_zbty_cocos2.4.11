...
var d = function (e) {
  ...
  o.prototype.init = function (e) {
    ...
    if (cc.sys.localStorage.getItem("starObj_wenzizhaobutong")) {
      window.starObj = JSON.parse(cc.sys.localStorage.getItem("starObj_wenzizhaobutong"));
    }
    if (window.home && window.home.isModelNowInModel12()) {
      o = Number(cc.sys.localStorage.getItem("level12_wenzizhaobutong") || 1);
      ...
      o = Number(cc.sys.localStorage.getItem("level" + window.model + "_wenzizhaobutong") || 1);
    }
    if (e < o) {
