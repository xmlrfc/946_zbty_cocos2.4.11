...
var d = function (e) {
  ...
  o.prototype.initRewardedAdCommon = function (e) {
    try {
      if (window.vivoOriginAdThis.nodeBottom) {
        ...
        window.vivoOriginAdThis.nodeBottom.zIndex = 32000;
      }
      console.log("原生广告加载开始");
      window.customAdCount = window.customAdCountNext;
      var o = window.customAdCount;
      ...
      if (window.miniPlatForm == "oppo") {
        ...
        this.showAd(window.common_hall.getCommonObj("vivoCustomAdId"), o, 0.33, true, function () {
          window.vivoOriginAdThis.nextStepNoAd();
        }, function () {});
      }
    } catch (t) {
  ...
  o.prototype.initRewardedMiddleAd = function () {
    try {
      ...
      if (window.miniPlatForm == "oppo") {
        ...
        this.showAd(window.common_hall.getCommonObj("vivoCustomAdId"), e, 0.33, false, function () {
          window.vivoOriginAdThis.nextStepNoMiddleAd();
        }, function () {});
      }
    } catch (o) {
  ...
  o.prototype.loadOppoCustomAd = function () {
    if (window.fromBoxUIFlag && window.loadBoxUIFlag) {
      ...
      this.loadOppoAd(window.common_hall.getCommonObj("oppoCustomAdId"), e, 0.5, false, function () {}, function () {});
    }
  };
  o.prototype.loadOppoBannerAd = function () {
    ...
    this.loadOppoAd(window.common_hall.getCommonObj("oppoCustomAsBannerAdId"), e, 0.8, false, function () {}, function () {});
  };
    ...
    try {
      ...
      if (qg && qg.createCustomAd) {
        ...
        window.customAd[o].onShow(function () {
          ...
          console.log("originEndAdShowSuccessCount", window.originEndAdShowSuccessCount);
  ...
  o.prototype.nextStepNoMiddleAd = function () {
    ...
    if (window.popGetGift && window.popGetGift.mask) {
      window.popGetGift.mask.active = false;
    }
  };
  o.prototype.nextStepNoAd = function () {
    ...
    if (window.getTips && window.getTips.mask) {
      window.getTips.mask.active = false;
    }
    if (window.adGetTips && window.adGetTips.mask) {
      window.adGetTips.mask.active = false;
    }
    if (window.countdownGameover && window.countdownGameover.mask) {
      window.countdownGameover.mask.active = false;
    }
    if (window.home && window.home.mask) {
      window.home.mask.active = false;
    }
    if (window.game && window.game.mask) {
      window.game.mask.active = false;
    }
  };
