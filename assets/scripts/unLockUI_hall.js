...
var d = function (e) {
  ...
  o.prototype.playVideo = function () {
    window.vivoVideoAd_hall.initRewardedAd(function () {
      window.adUtil.toast("恭喜，当前模式已解锁");
      cc.sys.localStorage.setItem("unlock" + window.gameName, "1");
      this.node.destroy();
    }.bind(this), function () {});
  };
