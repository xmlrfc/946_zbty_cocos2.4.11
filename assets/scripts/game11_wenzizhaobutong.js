    ...
    return a(this, undefined, undefined, function () {
      ...
      return c(this, function (r) {
        switch (r.label) {
          ...
          case 1:
            e.levelResModel11_wenzizhaobutong = t.apply(o, [i.apply(n, [r.sent()])]);
            this.levelData = window.levelResModel11_wenzizhaobutong.json.data[window.currentLevel - 1];
            this.levelData.pos = [this.levelData.pos];
            return [2];
        }
      });
    });
