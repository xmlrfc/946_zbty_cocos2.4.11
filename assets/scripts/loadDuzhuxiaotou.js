...
exports.loadGame = function (e) {
  return n(this, undefined, undefined, function () {
    ...
    return i(this, function () {
      window.objectName_hall = "duzhuxiaotou";
            ...
            switch (o.label) {
              case 0:
                if (window.model != 1) {
                  ...
                  return [4, window.adUtil.loadJsonByBundleSync("resources_" + window.model + "_duzhuxiaotou", "json/json1/level")];
                }
              case 1:
                e = o.sent();
                window.levelMaxModel = Object.keys(e.json).length;
                o.label = 2;
              case 2:
