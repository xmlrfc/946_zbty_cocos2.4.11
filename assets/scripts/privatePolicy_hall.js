...
var d = function (e) {
  ...
  o.prototype.agree = function () {
    var e = cc.sys.localStorage.getItem("privatePolicy");
    this.privatePolicyNode.active = false;
    if (!(e || window.miniPlatForm != "vivoApp" && window.miniPlatForm != "oppoApp")) {
      window.fmJava.onPrivacyAgreed();
    }
    if (!(e || window.miniPlatForm != "4399App")) {
