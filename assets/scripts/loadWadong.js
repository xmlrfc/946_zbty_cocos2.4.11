...
exports.loadGame = function (e) {
  return n(this, undefined, undefined, function () {
    ...
    return i(this, function () {
      window.objectName_hall = "wadong";
      cc.game.groupList = ["default", "barrier", "ball", "dirty"];
      cc.game.collisionMatrix = [[false], [false, true, true], [false, true, true, true], [false, false, true, false]];
      window.powerControl.decreasePower(function () {
        return n(o, undefined, undefined, function () {
          ...
          return i(this, function (t) {
            switch (t.label) {
              case 0:
                window.model = "model" + e;
                window.currentLevel = Number(cc.sys.localStorage.getItem("level" + window.model + "_wadong") || 1);
                o = window;
                return [4, window.adUtil.loadDirByBundleSync("resources_1_wadong", "json/json" + window.model.replace("model", ""))];
              case 1:
                o.levelRes = t.sent();
