  ...
  o.prototype.loadConfig = function () {
    return a(this, undefined, undefined, function () {
      ...
      return c(this, function (c) {
        switch (c.label) {
          case 0:
            if (window.levelResModel18_wenzizhaobutong) {
              return [3, 2];
            } else {
              e = window;
          ...
          case 1:
            e.levelResModel18_wenzizhaobutong = c.sent();
            c.label = 2;
          case 2:
            if (window.ziWrongModel18) {
              return [3, 4];
            } else {
              o = window;
          ...
          case 3:
            o.ziWrongModel18 = c.sent();
            c.label = 4;
          case 4:
            t = window.ziWrongModel18.json.data;
            this.jielongData = window.levelResModel18_wenzizhaobutong.json[window.currentLevel - 1];
