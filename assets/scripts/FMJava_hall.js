...
var n = function () {
  function e() {}
  e.onPrivacyAgreed = function () {
    if (cc.sys.platform != cc.sys.ANDROID || window.miniPlatForm != "vivoApp" && window.miniPlatForm != "oppoApp") {
      cc.director.loadScene("home" + window.common_hall.getCommonObj("homeSceneSkin"));
    } else {
      jsb.reflection.callStaticMethod("org/cocos2dx/javascript/AppActivity", "onPrivacyAgreed", "()V");
    }
  };
  e.loadHomeScene = function () {
    cc.director.loadScene("home" + window.common_hall.getCommonObj("homeSceneSkin"));
  };
